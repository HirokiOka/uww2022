  ...
  <div>
      ...
      <p className='text-center'>〒656-2306 兵庫県淡路市夢舞台1番地</p>
        ...
        <div className='p-3 m-3 border-black rounded-lg border-2'>
          <p>ユビキタス・ウェアラブル技術の発展はめざましく、これらの技術に関する研究開発が活発に行われています。神戸大学塚本・寺田研究室およびNPO法人ウェアラブルコンピュータ研究開発機構では、ユビキタス・ウェアラブルワークショップを2007年以来毎年開催し、今年は16回目となります。UWW2022では、ワクチンの十分な摂取回数(3回)を求めることになりました。(打てない方は個別相談となります。)</p>
