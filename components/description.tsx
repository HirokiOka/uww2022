  ...
  <div>
      ...
      <div className='p-3 m-3 border-black rounded-lg border-2'>
        <h2 className='text-4xl text-center pb-2 underline font-mono'>Welcome to UWW2022</h2>
          <p>ユビキタス・ウェアラブル技術の発展はめざましく、これらの技術に関する研究開発が活発に行われています。神戸大学塚本・寺田研究室およびNPO法人ウェアラブルコンピュータ研究開発機構では、ユビキタス・ウェアラブルワークショップを2007年以来、毎年開催しており今年は16回目となります。UWW2022では、ワクチンの十分な摂取回数 (3回) を求めることになりました。打てない方は個別相談となりますので、運営へとメールでご連絡ください</p>
